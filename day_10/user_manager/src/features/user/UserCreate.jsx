            ...
            <div className="col-md-6">
                <div className="bg-light p-4">
                    ...
                    <div className="mb-3">
                        ...
                        <select className="form-select" id="address" value={tinh} onChange={(e) =>setTinh(e.target.value)}>
                ...
                <div className="text-center mt-3">
                    ...
                    <button className="btn btn-success" id="btn-save" onClick={()=>handleAdd(userName,userEmail,userPhone,tinh,userPassword)}>Tạo User</button>
                </div>
            </div>
        </div>
    </div>
